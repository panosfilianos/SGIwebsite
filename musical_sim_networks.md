...
***So, after actually listening to songs with high distance between their elements, we came up with a second idea, regarding how we are goint to use our vector. And that is the idea we kept :***<br>
